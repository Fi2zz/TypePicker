...
var TypePicker = (function () {
    ...
    TypePicker.prototype.disable = function (_a) {
        ...
        state.endDate = or(byCondition(isDate)(parse$$1(from))(function (date) { return date; }))(endDate);
        state.startDate = or(byCondition(isDate)(parse$$1(to))(function (date) { return date; }))(startDate);
        if (state.startDate) {
        ...
        var checkCanGoNext = function (start) { return function (end) { return function (next) {
            var result = !(isDate(start) && isDate(end) && end < start);
            if (result) {
                next(start, end);
            }
        }; }; };
